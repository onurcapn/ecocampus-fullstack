...
│   ├── config/
│   │   └── db.js              # PostgreSQL bağlantı ayarları
│   ├── controllers/
│   │   ├── authController.js  # Kimlik doğrulama mantığı
│   │   └── productController.js # Ürün işlemleri mantığı
│   ├── models/
│   │   ├── User.js            # Kullanıcı veritabanı sorguları
│   │   └── Product.js         # Ürün veritabanı sorguları
│   ├── routes/
│   │   ├── authRoutes.js      # Auth endpoint'leri
│   │   └── productRoutes.js   # Product endpoint'leri
│   ├── middleware/
